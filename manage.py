...
def deploy():
    ...
    course3 = Course(course_number="NTDT200",title='Nutrition Concepts', description='Functions and sources of nutrients, dietary adequacy, energy balance and metabolism with emphasis on health promotion',professor=professor3)
    course4 = Course(course_number="ART180",title='Digital Photography ', description='Introduces the basics of photography as a way to communicate ideas emphasizing content, composition, and technique',professor=professor4)
